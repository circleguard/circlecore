...
def mod_to_int(mod):
    """
    Returns the integer representation of a mod string.
    The mods in the string can be in any order - "HDDT" will return
    the same number as "DTHD". A `+` may not be prepended to the passed string.

    Parameters
    ----------
    mod: str
        The modstring to convert.

    Returns
    -------
    int
        The integer representation of `mod`.
    """
