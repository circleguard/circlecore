...
from circleguard.enums import (Detect, RatelimitWeight, Keys, Key, StealDetect, RelaxDetect, Mod, CorrectionDetect,
                               MacroDetect, CleanMode, ValidateCMode, SynchronizeCMode, AlignCMode, SearchCMode)
...
__all__ = ["Circleguard", "set_options", "Check", "Replay", "ReplayMap", "StealDetect", "RelaxDetect",
           ...
           "Mod", "CorrectionResult", "MapUser", "MacroDetect", "MacroResult", "CleanMode", "ValidateCMode",
           "SynchronizeCMode", "AlignCMode", "SearchCMode"]
