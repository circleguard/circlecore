...
argparser.add_argument("-a", "--auto-threshold", help="Sets the threshold to a number of standard deviations below the average similarity", type=float, default=-1, dest="auto_thresh")
